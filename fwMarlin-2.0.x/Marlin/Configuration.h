...
/**
 * Marlin 3D para ZDelta
 * 
 * Basado en Marlin, desarrollado por @zepyr
 * 
 * Bigtreetech SKR 1.3
 * Fin de carrera opticos
 * Bondtech 3:1
 * E3D V6 all-metal con termistor PT1000
 * Calefactor de 50W
 * Cama caliente
 * 
 * Area de impresion:
...
#define CUSTOM_MACHINE_NAME "ZDelta"
...
#define EXTRUDE_MAXLENGTH 200 //Revisar y poner misma cantidad que la longitud del tubo bowden.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 285.0 //285.0            // (mm) Get this value from G33 auto calibrate
